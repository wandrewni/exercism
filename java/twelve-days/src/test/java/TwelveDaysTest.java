...
public class TwelveDaysTest {
    ...
    @Test
    public void testMultipleVerses2() {
        String expectedVerseOneToThree = "On the second day of Christmas my true love gave to me, two Turtle Doves, " +
                "and a Partridge in a Pear Tree.\n\n" +
                "On the third day of Christmas my true love gave to me, three French Hens, two Turtle Doves, " +
                "and a Partridge in a Pear Tree.\n";
        assertEquals(expectedVerseOneToThree, twelveDays.verses(2, 3));
    }
